...
var TaroCropperComponent = /** @class */ (function (_super) {
    ...
    TaroCropperComponent.prototype.componentDidMount = function () {
        ...
        this.cropperCanvasContext = Taro__default['default'].createCanvasContext(cropperCanvasId, this);
        this.cropperCutCanvasContext = Taro__default['default'].createCanvasContext(cropperCutCanvasId, this);
    ...
    TaroCropperComponent.prototype.cut = function () {
        ...
        return new Promise(function (resolve, reject) {
            var scope = process.env.TARO_ENV === 'h5' ? _this : _this;
    ...
    TaroCropperComponent.prototype.render = function () {
        var _this = this;
        var _a = this.props, width = _a.width, height = _a.height, cropperCanvasId = _a.cropperCanvasId, fullScreen = _a.fullScreen, 
        // fullScreenCss,
        themeColor = _a.themeColor, hideFinishText = _a.hideFinishText, cropperWidth = _a.cropperWidth, cropperHeight = _a.cropperHeight, cropperCutCanvasId = _a.cropperCutCanvasId, hideCancelText = _a.hideCancelText, onCancel = _a.onCancel, finishText = _a.finishText, cancelText = _a.cancelText;
        ...
        var isFullScreenCss = fullScreen;
        var croperStyle = isFullScreenCss ? {} : {
            position: 'relative'
        };
        var canvasStyle = {
        ...
        if (!hideFinishText) {
            var finishStyle = {
                ...
                color: themeColor,
                textAlign: "right",
                fontSize: Taro__default['default'].pxTransform(32),
                bottom: Taro__default['default'].pxTransform(30),
                right: Taro__default['default'].pxTransform(30),
            };
        ...
        if (!hideCancelText) {
            var cancelStyle = {
                ...
                fontSize: Taro__default['default'].pxTransform(32),
                bottom: Taro__default['default'].pxTransform(30),
                left: Taro__default['default'].pxTransform(30),
            };
            cancel = React__default['default'].createElement(components.CoverView, { style: cancelStyle, onClick: onCancel }, cancelText);
        }
        return (React__default['default'].createElement(components.View, { className: "taro-cropper " + (isFullScreenCss ? 'taro-cropper-fullscreen' : ''), style: croperStyle },
