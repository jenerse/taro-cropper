...
class TaroCropperComponent extends PureComponent {
    constructor(props) {
        super(props);
        this.imageLeft = 0;
        this.imageTop = 0;
        this.imageLeftOrigin = 0;
        this.imageTopOrigin = 0;
        this.width = 0;
        this.height = 0;
        this.cropperWidth = 0;
        ...
        this.oldScale = 1;
        this.newScale = 1;
        this.lastScaleImageWidth = 0;
        this.lastScaleImageHeight = 0;
     ...
     */
    updateInfo(props) {
        const { width, height, cropperWidth, cropperHeight, src, fullScreen } = props;
    ...
    componentDidMount() {
        const { cropperCanvasId, cropperCutCanvasId } = this.props;
     ...
     * @private
     */
    _outsideBound(imageLeft, imageTop) {
        this.imageLeft =
    ...
    _getNewScale(oldScale, oldDistance, touch0, touch1) {
        const xMove = touch1.x - touch0.x;
        const yMove = touch1.y - touch0.y;
     ...
     */
    cut() {
        const { cropperCutCanvasId, fileType, quality } = this.props;
        return new Promise((resolve, reject) => {
    ...
    render() {
        const { width, height, cropperCanvasId, fullScreen, 
        // fullScreenCss,
        themeColor, hideFinishText, cropperWidth, cropperHeight, cropperCutCanvasId, hideCancelText, onCancel, finishText, cancelText } = this.props;
        ...
        return (React.createElement(View, { className: `taro-cropper ${isFullScreenCss ? 'taro-cropper-fullscreen' : ''}`, style: croperStyle },
